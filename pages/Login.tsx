    ...
    setTimeout(() => {
      ...
      if (foundUser && password === 'password') {
        ...
        navigate('/');
         ...
         // Auto-register new email logically like we do for Google Auth
         const autoGeneratedStudent = {
           id: Math.floor(100000 + Math.random() * 900000).toString(),
           name: normalizedId.split('@')[0], // Make a basic name out of email
           email: normalizedId,
        ...
        if (googleUser.email) {
          ...
          if (foundUser) {
            ...
            navigate('/');
             ...
             // Dynamically generate a Student profile for new Google Logins
             const autoGeneratedStudent = {
               id: Math.floor(100000 + Math.random() * 900000).toString(),
             ...
             // Save to user directory so Admin can see them
             const allUsers = JSON.parse(localStorage.getItem('opas_users') || JSON.stringify(MOCK_USERS_LIST));
